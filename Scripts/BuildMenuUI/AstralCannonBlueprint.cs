...
public class AstralCannonBlueprint : Blueprints
{
    public override void PlaceBuilding()
    {
        float cost = buildingPrefab.GetComponent<AstralCannonNeeds>().astralCannonCost;
        float power = buildingPrefab.GetComponent<AstralCannonNeeds>().astralCannonPower;
        int workers = buildingPrefab.GetComponent<AstralCannonNeeds>().astralCannonWorkers;
