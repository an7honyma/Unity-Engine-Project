...
public class SuperReactorBlueprint : Blueprints
{
    public override void PlaceBuilding()
    {
        float cost = buildingPrefab.GetComponent<SuperReactorNeeds>().superReactorCost;
        int workers = buildingPrefab.GetComponent<SuperReactorNeeds>().superReactorWorkers;
