...
public class DragonheadPathFinding : MonoBehaviour
{
    ...
    public GameObject dragonheadProjectilePrefab;
        ...
        if (target != null)
        {
            ...
            else
            {
                ...
                if (Time.time >= nextTimeToFire && dotProd > 0.9)
                {
                    ...
                    var dragonheadProjectile1 = Instantiate(dragonheadProjectilePrefab, projectileOrigin1.position, projectileOrigin1.rotation);
                    dragonheadProjectile1.GetComponent<Rigidbody>().velocity = projectileOrigin1.forward * projectionSpeed;
                    var dragonheadProjectile2 = Instantiate(dragonheadProjectilePrefab, projectileOrigin2.position, projectileOrigin2.rotation);
                    dragonheadProjectile2.GetComponent<Rigidbody>().velocity = projectileOrigin2.forward * projectionSpeed;
                    var dragonheadProjectile3 = Instantiate(dragonheadProjectilePrefab, projectileOrigin3.position, projectileOrigin3.rotation);
                    dragonheadProjectile3.GetComponent<Rigidbody>().velocity = projectileOrigin3.forward * projectionSpeed;
                    var dragonheadProjectile4 = Instantiate(dragonheadProjectilePrefab, projectileOrigin4.position, projectileOrigin4.rotation);
                    dragonheadProjectile4.GetComponent<Rigidbody>().velocity = projectileOrigin4.forward * projectionSpeed;
                }
            }
