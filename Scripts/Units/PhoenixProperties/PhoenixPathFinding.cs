...
public class PhoenixPathFinding : MonoBehaviour
{
    ...
    public GameObject phoenixProjectilePrefab;
        ...
        if (target != null)
        {
            ...
            else
            {
                ...
                if (Time.time >= nextTimeToFire && dotProd > 0.9)
                {
                    ...
                    var phoenixProjectile1 = Instantiate(phoenixProjectilePrefab, projectileOrigin1.position, projectileOrigin1.rotation);
                    phoenixProjectile1.GetComponent<Rigidbody>().velocity = projectileOrigin1.forward * projectionSpeed;
                    var phoenixProjectile2 = Instantiate(phoenixProjectilePrefab, projectileOrigin2.position, projectileOrigin2.rotation);
                    phoenixProjectile2.GetComponent<Rigidbody>().velocity = projectileOrigin2.forward * projectionSpeed;
                    var phoenixProjectile3 = Instantiate(phoenixProjectilePrefab, projectileOrigin3.position, projectileOrigin3.rotation);
                    phoenixProjectile3.GetComponent<Rigidbody>().velocity = projectileOrigin3.forward * projectionSpeed;
                    var phoenixProjectile4 = Instantiate(phoenixProjectilePrefab, projectileOrigin4.position, projectileOrigin4.rotation);
                    phoenixProjectile4.GetComponent<Rigidbody>().velocity = projectileOrigin4.forward * projectionSpeed;
                }
            }
